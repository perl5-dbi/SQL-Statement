...
my %calcs = (
  q{SELECT id,host,signature,message FROM log WHERE time_stamp < (%d - ( 4 * 60 )) ORDER BY id} => '8^ernie^rpc.statd^starting^9^ernie^savecore^no core dump^10^ernie^postfix/postfix-script^starting the Postfix mail system^11^ernie^rpcbind^connect from 127.0.0.1 to dump()^12^ernie^sshd^last message repeated 2 times^13^ernie^shutdown^poweroff by root:^14^ernie^shutdown^rebooted by root^15^ernie^sshd^Server listening on :: port 22.^16^ernie^sshd^Server listening on 0.0.0.0 port 22.^17^ernie^sshd^Received SIGHUP; restarting.',
  q{SELECT id,host,signature,message FROM log WHERE (time_stamp > (%d - 5)) AND (time_stamp < (%d + 5)) ORDER BY id} => '1^bert^/netbsd^Copyright (c) 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005,^2^bert^/netbsd^2006, 2007, 2008, 2009^3^bert^/netbsd^The NetBSD Foundation, Inc.  All rights reserved.^4^bert^/netbsd^Copyright (c) 1982, 1986, 1989, 1991, 1993^5^bert^/netbsd^The Regents of the University of California.  All rights reserved.^6^bert^/netbsd^^7^bert^/netbsd^NetBSD 5.99.21 (BERT) #0: Mon Nov 30 08:16:07 CET 2009',
  q{SELECT id,host,signature,message FROM log WHERE time_stamp BETWEEN ( %d - 5, %d + 5) ORDER BY id} => '1^bert^/netbsd^Copyright (c) 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005,^2^bert^/netbsd^2006, 2007, 2008, 2009^3^bert^/netbsd^The NetBSD Foundation, Inc.  All rights reserved.^4^bert^/netbsd^Copyright (c) 1982, 1986, 1989, 1991, 1993^5^bert^/netbsd^The Regents of the University of California.  All rights reserved.^6^bert^/netbsd^^7^bert^/netbsd^NetBSD 5.99.21 (BERT) #0: Mon Nov 30 08:16:07 CET 2009',
);
