...
my %joins = (
  ...
  q{SELECT DISTINCT applname, appluniq, version, surname, familyname, phone, nodename FROM APPL, PREC, NODE, CONTACT, APPL_CONTACT WHERE appl_type='CUPS' AND APPL.id=PREC.appl_id AND PREC.node_id=NODE.id AND APPL_CONTACT.appl_id=APPL.id AND APPL_CONTACT.contact_id=CONTACT.id ORDER BY applname} => 'PRN1^PRN1-4.B2^1.1.22^Helge^Brunft^+41-123-45678-09^piggy^PRN1^PRN1-4.B2^1.1.22^Helge^Brunft^+41-123-45678-09^samson^PRN1^PRN1-4.B1^1.1.22^Helge^Brunft^+41-123-45678-09^samson^PRN1^PRN1-4.B1^1.1.22^Helge^Brunft^+41-123-45678-09^piggy^PRN2^PRN2-4.B2^1.1.22^Helge^Brunft^+41-123-45678-09^kermit^PRN2^PRN2-4.B2^1.1.22^Helge^Brunft^+41-123-45678-09^tiffy',
